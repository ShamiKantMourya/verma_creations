...
const Services: React.FC = () => {
  return (
    <div className='flex flex-col flex-wrap mt-10 h-auto justify-between'>
      ...
      <div className='flex flex-wrap justify-evenly px-8 w-full'>
        <figure className='border-2 border-white rounded-md mt-3 h-96 cursor-pointer w-80'>
        ...
        <figure className='border-2 border-white rounded-md my-3 w-80 h-96 cursor-pointer'>
        ...
        <figure className='border-2 border-white rounded-md mobile:mb-3 w-80 h-96 cursor-pointer'>
